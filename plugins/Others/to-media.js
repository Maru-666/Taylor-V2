...
let handler = async (m, {
    ...
    if (command == 'towebp') {
        ...
        await conn.sendFile(m.chat, res, 'out.webp', m, false, {
            mimetype: 'image/webp',
    ...
    if (command == 'webptogif') {
        ...
        await conn.sendFile(m.chat, res, 'out.gif', m, false, {
            mimetype: 'image/gif',
            thumbnail: Buffer.alloc(0)
        })
    }
    ...
    if (command == 'webptomp4') {
        ...
        await conn.sendFile(m.chat, res, 'out.mp4', m, false, {
            mimetype: 'video/mp4',
            thumbnail: Buffer.alloc(0)
        })
    }
    ...
    if (command == 'topng') {
        ...
        await conn.sendFile(m.chat, res, 'out.png', m, false, {
            mimetype: 'image/png',
            thumbnail: Buffer.alloc(0)
        })
    }
    ...
    if (command == 'urltoimg') {
        ...
        await conn.sendFile(m.chat, res, 'out.jpeg', m, false, {
            mimetype: 'image/jpeg',
            thumbnail: Buffer.alloc(0)
        })
    }
